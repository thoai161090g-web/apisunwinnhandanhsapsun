...
async function processApiData() {
    try {
        ...
        const jsonOutput = {
            "PHIÊN": latestRecord.Phien,
            "XX 1": latestRecord.Xuc_xac_1,
            "XX 2": latestRecord.Xuc_xac_2,
            "XX 3": latestRecord.Xuc_xac_3,
            "Tổng": latestRecord.score,
            "PHIÊN HIỆN TẠI": nextPhien,
            "DU ĐOÁN": predictionResult.prediction,
            "LOẠI CẦU": predictionResult.loai_cau,
            "ĐỘ TIN CẬY": predictionResult.do_tin_cay,
            "KẾT QUẢ DU ĐOÁN": statusCurrent,
            "Thong_ke": {
                "tong": stats.total,
                "dung": stats.correct,
                "sai": stats.wrong,
